...
% c(keylist_mgr). c(keylist). keylist_mgr:start(). keylist_mgr:start_child(#{name => keylist1, restart => permanent}).

% c(keylist_mgr). c(keylist). keylist_mgr:start(). keylist_mgr:start_child(#{name => keylist1, restart => permanent}). keylist:add(keylist1, "first_key", "first_value", "first_comment"). keylist:add(keylist2, "second_key", "second_value", "second_comment").

% keylist:add(keylist1, "first_key", "first_value", "first_comment").
% keylist:is_member(keylist1, "first_key").
% keylist:take(keylist1, "first_key").
% keylist:find(keylist1, "first_key").
% keylist:delete(keylist1, "first_key1").
